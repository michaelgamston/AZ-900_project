...
- 1) Develop my infrastructure-as-code skills by deploying cloud resources using terraform.
- 2) Develop my knowledge of Azure's cloud resources and how I implement them.
- 3) Combine my existing development knowledge to complete full cloud based project within a new ecosystem.
